...
class SingerAdapter(private val layoutInflater: LayoutInflater, private val singerList: List<Singer>, @param:LayoutRes private val rowLayout: Int) : RecyclerView.Adapter<SingerAdapter.ViewHolder>() {
